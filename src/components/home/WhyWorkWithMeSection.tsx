...
import { Brain, Rocket, UserCheck } from 'lucide-react';
  ...
  return (
    <SectionWrapper id="why-work-with-me">
      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 items-stretch">
        <Card className="bg-card border border-border rounded-lg shadow-md hover:shadow-xl hover:border-primary/40 transition-all duration-300 flex flex-col">
          <CardHeader>
        ...
        <Card className="bg-card border border-border rounded-lg shadow-md hover:shadow-xl hover:border-primary/40 transition-all duration-300 flex flex-col md:col-span-2 lg:col-span-1">
          <CardHeader>
            <div className="mx-auto bg-primary/10 p-3 rounded-full w-fit mb-4">
