...
// Custom Pixelated Orange/Black Square Cursor
...
export function SmoothCursor({
  cursor = <PixelCursor />, // Use the custom pixelated cursor
  springConfig = {
    damping: 45,
    stiffness: 400,
    mass: 1,
...
}: SmoothCursorProps): JSX.Element | null {
  ...
  // Reduce scale effect as pixel cursor is smaller
  ...
  useEffect(() => {
    ...
    const smoothMouseMove = (e: MouseEvent) => {
      ...
      if (speed > 0.1) {
        ...
        scale.set(0.95);
        setIsMoving(true); // Keep isMoving for potential future use
